...
#define LEFT_SPC LT(1, KC_ENTER)
#define RGHT_SPC LT(2, KC_SPC)
#define LT_3DASH LT(3, KC_MINS)
#define SLASH2  LT(2, KC_SLSH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, KC_NUBS,    KC_Z,    KC_X,    KC_C,    KC_V,                         KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, SLASH2,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, KC_LCTL,LEFT_SPC,   RGHT_SPC, KC_LALT, KC_MINS
                                      //`--------------------------'  `--------------------------'
  ),
