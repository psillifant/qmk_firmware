...
[_LYRONE] = LAYOUT_planck_2x2u(
    ...
    _______,   KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_MUTE,  KC_NO,    KC_NO,    KC_MUTE,
    _______,   _______,  _______,  _______,  _______,            _______,            _______,  _______,  _______,  _______
),

[_LYRTWO] = LAYOUT_planck_2x2u(
    KC_ESC,    KC_NO,    KC_UP,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_HOME,  KC_DEL,
